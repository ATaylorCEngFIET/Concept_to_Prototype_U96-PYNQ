...
repo_board_folder = f'boards/{board}/session_2'
...
def copy_notebooks():
    ...
    dst_nb_dir = os.path.join(board_notebooks_dir, 'Concept_to_Prototype_U96-PYNQ')
...
setup(
	...
	description= "Concept to Prototype Ultra96 Session 2 PYNQ",
)